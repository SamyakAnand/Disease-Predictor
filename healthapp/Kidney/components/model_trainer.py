...
import pandas as pd
import mlflow
from healthapp.Kidney.entity.artifact_entity import (
...
from healthapp.Kidney.entity.config_entity import DataTransformationConfig,ModelTrainerConfig
from healthapp.Kidney.utils.main_utils.utils import (
    save_object,
    load_object,
    load_numpy_array_data,
    evaluate_models)
from healthapp.Kidney.utils.ml_utils.metric.classification_metric import get_classification_score,precision_score,recall_score

from healthapp.Kidney.utils.ml_utils.model.estimator import HealthModel
...
class ModelTrainer:
    ...
    "degree": [2, 3, 4],  # Degree for polynomial kernel
        ...
        save_object("healthapp/Kidney/final_models/kidney_model.pkl",best_model)
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            #loading training data array and testing data array
