...
import pandas as pd
import mlflow
from healthapp.Cancer.entity.artifact_entity import (
...
from healthapp.Cancer.entity.config_entity import DataTransformationConfig,ModelTrainerConfig
from healthapp.Cancer.utils.main_utils.utils import (
    save_object,
    load_object,
    load_numpy_array_data,
    evaluate_models)
from healthapp.Cancer.utils.ml_utils.metric.classification_metric import get_classification_score,precision_score,recall_score

from healthapp.Cancer.utils.ml_utils.model.estimator import HealthModel
...
class ModelTrainer:
    ...
    "degree": [2, 3, 4],  # Degree for polynomial kernel
        ...
        save_object("healthapp/Cancer/final_models/cancer_model.pkl",best_model)
