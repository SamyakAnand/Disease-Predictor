...
from healthapp.utils.main_utils.utils import save_numpy_array_data,save_object
...
class DataTransformation:
    ...
    def get_data_transformaer_obj(cls)->Pipeline:
        """
        ...
        Returns:
          A Pipeline object
        """
        logging.info("Entered get_data_transformaer_obj method of Transformation class ")
        try:
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            preprocessor=self.get_data_transformaer_obj()
